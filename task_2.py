...
class Report:
    ...
    def generate_excel(salary_by_year: dict, selected_vacancy_salary_by_year: dict,
        ...
        wb.save(Report.output_filename)
    ...
    def generate_image(salary_by_year: dict, selected_vacancy_salary_by_year: dict,
        ...
        fig, ((salary_by_year_axis, count_by_year_axis), (salary_by_area_axis, fraction_by_area_axis)) = plt.subplots(2, 2)
        Report.generate_salary_by_year_axis(salary_by_year_axis, salary_by_year, selected_vacancy_salary_by_year, vacancy_name)
        Report.generate_count_by_year_axis(count_by_year_axis, vacancies_count_by_year, selected_vacancy_count_by_year, vacancy_name)
    ...
    @staticmethod
    def generate_salary_by_year_axis(ax, salary_by_year: dict, selected_vacancy_salary_by_year: dict, vacancy_name: str):
        ...
        selected_vacancy_bar = ax.bar(x+width/2, selected_vacancy_average_salaries, width, label=f"з/п {vacancy_name}")
    ...
    @staticmethod
    def generate_count_by_year_axis(ax, vacancies_count_by_year: dict, selected_vacancy_count_by_year: dict, vacancy_name: str):
        ...
        selected_vacancy_bar = ax.bar(x+width/2, selected_vacancy_count, width, label=f"Количество вакансий\n{vacancy_name}")
