...
class DataSet:
    ...
    def get_statistics_using_pandas(self, path_to_csv_file: str, selected_vacancy: str):
        ...
        if self.check_input():
            ...
            if not data_set.is_empty_file():
                if self.output_type == "Вакансии":
                    ...
                    data_set.get_statistics_using_pandas(self.csv_file_name, self.vacancy_name)
